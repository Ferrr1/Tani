// app/(operator)/users/[detail].tsx (atau lokasi komponen detail kamu)
    ...
    try {
      ...
      if (isSelf) {
        ...
        if (pendingAnswer.length > 0) {
          const uid = user?.id;
          if (!uid)
            throw new Error("Session tidak valid: user.id tidak ditemukan");
        ...
        { text: "Batal", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "Gagal",
                e?.message ?? "Tidak dapat menghapus pengguna.",
              );
            } finally {
              setSaving(false);
            }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.background }}>
      ...
      >
        ...
        >
          ...
          {/* Email */}
          <Text
            style={[styles.label, { color: C.text, marginTop: S.spacing.md }]}
          >
            Email
          </Text>
          <Controller
          ...
          {role === "user" && (
            <>
              ...
              {errors.landAreaHa && (
                <Text style={[styles.err, { color: C.danger }]}>
                  {errors.landAreaHa.message as string}
                </Text>
              )}
            </>
          )}
          ...
          {/* Footer buttons */}
          <View
            style={{ flexDirection: "row", gap: 12, marginTop: S.spacing.lg }}
          >
            {/* Save */}
            <Pressable
            ...
            {!isCreate && (
              ...
              >
                ...
                <Text
                  style={[styles.btnText, { fontFamily: Fonts.rounded as any }]}
                >
                  Hapus
                </Text>
              </Pressable>
